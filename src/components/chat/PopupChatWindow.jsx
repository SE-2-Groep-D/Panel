...
const PopupChatWindow = ({ onClose, userId, bedrijfId }) => {
  // Assuming userId is available here
    ...
    <div className="popup-chat-window">
      <div className="chat-header">
        {activeChat.otherUserId && (
          <button
            aria-label="Terug naar chat lijst"
        ...
        >
          <span className="x-icon">
            <FontAwesomeIcon
              icon={faXmark}
              className="close-icon fa-solid fa-lg"
            />
          </span>
        </button>
      </div>
